...
var _movie_collection = require('./movie_collection');

var _movie_collection2 = _interopRequireDefault(_movie_collection);

var _movie_maker = require('./movie_maker');

var _movie_maker2 = _interopRequireDefault(_movie_maker);
...
var _movie_model = require('./movie_model');

var _movie_model2 = _interopRequireDefault(_movie_model);

var MovieCollection = _backbone2['default'].Collection.extend({
  url: 'https://api.parse.com/1/classes/GoodMovies',
  model: _movie_model2['default'],
...
},{"./movie_model":4,"backbone":5}],3:[function(require,module,exports){
"use strict";
...
var MovieModel = _backbone2['default'].Model.extend({
